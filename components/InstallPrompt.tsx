 ...
 * invite l'utilisateur à installer HelloPos comme PWA. La bannière
    ...
    <div className="fixed inset-x-3 bottom-3 z-[100] mx-auto max-w-md">
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="font-semibold">Installer HelloPos</div>
          {platform === 'ios' ? (
            ...
            <p className="mt-0.5 text-xs text-ink-soft">
              Installez HelloPos pour une expérience plein écran sans barre de navigation.
            </p>
          )}
